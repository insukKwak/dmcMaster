...
//   /*======== 5. MIXED CHART 01 ========*/
  ...
  if (horBarChart1 !== null){
    var horBarChartOptions = {
      ...
      xaxis: {
        categories: ['India', 'USA', 'Canada', 'Russia', 'Austrolia', 'Argentina'],
        labels: {
  ...
  if (tableSmBarChart1 !== null){
    ...
    var randerTblSmChart1 = new ApexCharts(tableSmBarChart1, tableSmBarChartOption1);
  ...
  if (tableSmBarChart2 !== null){
    ...
    var randerTblSmChart2 = new ApexCharts(tableSmBarChart2, tableSmBarChartOption);
  ...
  if (tableSmBarChart3 !== null){
    ...
    var randerTblSmChart3 = new ApexCharts(tableSmBarChart3, tableSmBarChartOption3);
  ...
  if (tableSmBarChart4 !== null){
    ...
    var randerTblSmChart4 = new ApexCharts(tableSmBarChart4, tableSmBarChartOption4);
  ...
  if (tableSmBarChart5 !== null){
    ...
    var randerTblSmChart5 = new ApexCharts(tableSmBarChart5, tableSmBarChartOption5);
  ...
  if (tableSmBarChart6 !== null){
    ...
    var randerTblSmChart6 = new ApexCharts(tableSmBarChart6, tableSmBarChartOption6);
  ...
  if (tableSmBarChart7 !== null){
    ...
    var randerTblSmChart7 = new ApexCharts(tableSmBarChart7, tableSmBarChartOption7);
  ...
  if (tableSmBarChart8 !== null) {
    ...
    var randerTblSmChart8 = new ApexCharts(tableSmBarChart8, tableSmBarChartOption8);
  ...
  if (tableSmBarChart9 !==  null) {
    ...
    var randerTblSmChart9 = new ApexCharts(tableSmBarChart9,  tableSmBarChartOption9);
  ...
  if (tableSmBarChart10 !== null){
    ...
    var randerTblSmChart10 = new ApexCharts(tableSmBarChart10, tableSmBarChartOption10);
  ...
  if (tableSmBarChart11 !== null){
    ...
    var randerTblSmChart11 = new ApexCharts(tableSmBarChart11, tableSmBarChartOption11);
  ...
  if (tableSmBarChart12 !== null){
    ...
    var randerTblSmChart12 = new ApexCharts(tableSmBarChart12,  tableSmBarChartOption12);
  ...
  if (tableSmBarChart13 !== null){
    ...
    var randerTblSmChart13 = new ApexCharts(tableSmBarChart13, tableSmBarChartOption13);
  ...
  if (tableSmBarChart14 !== null){
    ...
    var randerTblSmChart14 = new ApexCharts(tableSmBarChart14, tableSmBarChartOption14);
  ...
  if (tableSmBarChart15 !== null){
    ...
    var randerTblSmChart15 = new ApexCharts(tableSmBarChart15, tableSmBarChartOption15);
  ...
  if (statusSmBarChart1 !== null) {
    ...
    var randerStatusSmChart1 = new ApexCharts(statusSmBarChart1, statusSmBarChartOption1);
  ...
  if (statusSmBarChart2 !== null) {
    ...
    var randerStatusSmChart2 = new ApexCharts(statusSmBarChart2, statusSmBarChartOption2);
  ...
  if (statusSmBarChart3 !== null) {
    ...
    var randerStatusSmChart3 = new ApexCharts(statusSmBarChart3, statusSmBarChartOption3);
...
/*======== 10.3 LINE CHART 03 ========*/
  ...
  if (barChartLg1 !== null){
    ...
    var items = document.querySelectorAll("#user-acquisition .nav-underline-active-primary .nav-item");
