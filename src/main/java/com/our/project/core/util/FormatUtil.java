...
public class FormatUtil {
	...
	/* ?‡¾ëª„ì˜„ï¿½ë¿´ï¿½ë¿‰ï¿½ê½Œ XSS ?—?‘¥ë¹Ÿï¿½?  è«›ì’–ê¹?ï¿½ë¸· ï¿½ë‹” ï¿½ì—³ï¿½ë’— ?‡¾ëª„ì˜„?‘œï¿? ï¿½ï¿½ï§£ë?Ğ¦ï¿½ì˜„æ¿¡ï¿½ è¹‚ï¿½ï¿½ì†š */
	...
	/*
	 * String, Map<String, String>, List<String>, List<Map<String, String>> ï¿½ì‚ï¿½ê¹­ï¿½ì“½ ï¿½ëœ²ï¿½ì” ï¿½ê½£ï¿½ë¿‰
	 * ï¿½ï¿½ï¿½ë¹ï¿½ê½Œ encodeXSS ï¿½ë–ï¿½ë»¾
	 */
	...
	public static Object encodeObjectForXSS(Object params, String parentKeyName) {
		...
		parentKeyName = FormatUtil.toString(parentKeyName);
		...
		if (params instanceof String) {
			...
			for (int i = 0; i < paramsList.size(); ++i) {
				paramsList.set(i, encodeObjectForXSS(paramsList.get(i), null));
			}
		}
